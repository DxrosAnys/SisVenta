            ...
            <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="img/imgindex/b1.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="img/imgindex/b4.jpg"  alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="img/imgindex/b3.jpg" alt="Third slide">
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="w3-row-padding">
                    <div class="w3-third w3-container w3-margin-bottom">
                        <img src="img/imgindex/d1.jpg" alt="Norway" style="width:90%" class="w3-hover-opacity">
                    ...
                    <div class="w3-third w3-container w3-margin-bottom">
                        <img src="img/imgindex/d2.jpg" alt="Norway" style="width:90%" class="w3-hover-opacity">
                        <div class="w3-container">
                    ...
                    <div class="w3-third w3-container">
                        <img src="img/imgindex/d3.jpeg" alt="Norway" style="width:90%" class="w3-hover-opacity">
                        <div class="w3-container">
                ...
                <div class="row featurette">
                    ...
                    <div class="col-md-6">
                        <img class="featurette-image img-responsive center-block"  width="540" height="400" src="img/imgindex/d4.jpg">
                    </div>
                </div>      
            </div>
        </div>
