        ...
        <div class="container">            
            ...
            <div class="container">
                ...
                <div class="w3-row-padding">
                    ...
                    <div class="w3-third w3-container w3-margin-bottom">
                        <img src="resources/img/imgindex/d2.jpg" alt="Norway" style="width:90%" class="w3-hover-opacity">
                        <div class="w3-container">
                    ...
                    <div class="w3-third w3-container">
                        <img src="resources/img/imgindex/d3.jpeg" alt="Norway" style="width:90%" class="w3-hover-opacity">
                        <div class="w3-container">
                ...
                <div class="row featurette">
                    ...
                    <div class="col-md-6">
                        <img class="featurette-image img-responsive center-block"  width="540" height="400" src="resources/img/imgindex/d4.jpg">
                    </div>
                </div>      
            </div>
        </div>
