...
<html>
   ...
   <body  background="img/bg-powerful.jpg">
        <div class="w3-top">
            <div class="w3-bar w3-white w3-card" id="myNavbar">
                ...
                <div class="w3-right w3-hide-medium">
                    <a href="catala.jsp" class="w3-bar-item w3-button"><i class="fa fa-bookmark"></i>CATAGOLO</a>
        ...
        <nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
            <a href="#team" class="w3-bar-item w3-button"><i class="fa fa-user"></i>CATALOGO</a>
            ...
            <a href="registroC.jsp" class="w3-bar-item w3-button"><i class="fa fa-users"></i>REGISTRO</a>
            <a href="login.jsp" class="w3-bar-item w3-button"><i class="fa fa-user"></i>USUARIO</a>
        </nav>
